...
<head>
    ...
    <style>
        ...
        /* Club Card */
        .club-card {
            background: #ffffff; border-radius: 18px; border: 1px solid #f1c1c1;
            padding: 25px 20px; text-align: center; transition: 0.4s ease;
        ...
        .club-btn {
            padding: 7px 18px; font-size: 13px; font-weight: 600; border-radius: 30px;
            border: none; background: linear-gradient(45deg, #e53935, #ff7043); color: white; transition: 0.3s;
        }
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="club-card">
                ...
                <h5>Sports Club</h5>
                <div class="category">Sports & Fitness</div>
                <div class="members">50 Members</div>
                <p>Participate in tournaments and training sessions regularly.</p>
                <div class="d-flex justify-content-center gap-2 mt-3">
                    <button class="club-btn joinBtn" data-club="Sports Club">Join</button>
                    <a href="club_detail.php?club=sports" class="club-btn">Details</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="club-card">
                ...
                <h5>Coding Club</h5>
                <div class="category">Technology & Innovation</div>
                <div class="members">40 Members</div>
                <p>Join hackathons and workshops to enhance your coding skills.</p>
                <div class="d-flex justify-content-center gap-2 mt-3">
                    <button class="club-btn joinBtn" data-club="Coding Club">Join</button>
                    <a href="club_detail.php?club=coding" class="club-btn">Details</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="club-card">
                ...
                <h5>Photography Club</h5>
                <div class="category">Arts & Visuals</div>
                <div class="members">45 Members</div>
                <p>Learn professional photography and showcase your talent.</p>
                <div class="d-flex justify-content-center gap-2 mt-3">
                    <button class="club-btn joinBtn" data-club="Photography Club">Join</button>
                    <a href="club_detail.php?club=photography" class="club-btn">Details</a>
                </div>
            </div>
        </div>
