    ...
    <div class="card custom-card p-4">
        ...
        <form id="addEventForm" enctype="multipart/form-data">
            ...
            <div class="mt-4 d-flex gap-2">
                ...
                <a href="all_events_page.php" class="btn btn-outline-secondary btn-effect">Cancel</a>
            </div>
...
$(document).ready(function(){
    ...
    $("#submitBtn").click(function(){
        ...
        Swal.fire({ title: "Please wait...", text: "Creating Event...", allowOutsideClick: false, didOpen: () => { Swal.showLoading(); } });
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response === "success"){
                    Swal.fire({ icon: "success", title: "Success", text: "Event Created Successfully!" })
                    .then(()=>{ window.location.href = "all_events_page.php"; });
                } else {
